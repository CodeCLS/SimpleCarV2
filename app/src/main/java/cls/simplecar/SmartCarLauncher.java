...
public class SmartCarLauncher {
    ...
    public void connect(Context context,SmartcarCallback smartcarCallback){
        SmartcarAuth smartcarAuth = new SmartcarAuth(
                ...
                new String[] {"read_vehicle_info", "read_compass","read_odometer","read_engine_oil","read_battery" ,"read_charge" ,
                        "control_charge" ,"read_speedometer", "read_thermometer","read_fuel" ,"read_location","control_security",
                        "read_odometer","read_tires","read_vin"},true,
